...
// line 630 "../../TestHarnessAssociations.ump"
public class ClassOptionalNAssociation
{
  ...
  public ClassOptionalNAssociation(Otherclass... allOtherclasses)
  {
    ...
    {
      throw new RuntimeException("Unable to create ClassOptionalNAssociation, must have 2 or fewer otherclasses, no duplicates. See http://manual.umple.org?RE001ViolationofImmutability.html");
    }
  }
