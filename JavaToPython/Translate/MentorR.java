...
// line 268 "../../TestHarnessAssociations.ump"
public class MentorR
{
  ...
  public MentorR(String aName, StudentR... allStudents)
  {
    ...
    if (!didAddStudents)
    {
      throw new RuntimeException("Unable to create MentorR, must have at least 3 students. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
