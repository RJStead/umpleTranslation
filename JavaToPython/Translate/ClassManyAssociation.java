...
// line 605 "../../TestHarnessAssociations.ump"
public class ClassManyAssociation
{
  ...
  public ClassManyAssociation(Otherclass... allOtherclasses)
  {
    ...
    {
      throw new RuntimeException("Unable to create ClassManyAssociation, must not have duplicate otherclasses. See http://manual.umple.org?RE001ViolationofImmutability.html");
    }
  }
