...
// line 51 "AfghanRainDesign.ump"
// line 167 "AfghanRainDesign.ump"
public class WorkersOnSurvey
{
  ...
  public String toString()
  {
    ...
    return super.toString() + "["+
            ...
            "  " + "date_assigned_from" + "=" + (getDate_assigned_from() != null ? !getDate_assigned_from().equals(this)  ? getDate_assigned_from().toString().replaceAll("  ","    ") : "this" : "null") + System.getProperties().getProperty("line.separator") +
            "  " + "date_assigned_to" + "=" + (getDate_assigned_to() != null ? !getDate_assigned_to().equals(this)  ? getDate_assigned_to().toString().replaceAll("  ","    ") : "this" : "null")
     + outputString;
  }
}