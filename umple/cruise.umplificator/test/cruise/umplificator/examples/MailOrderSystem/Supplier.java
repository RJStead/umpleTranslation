...
public class Supplier
{
  ...
  public ProductSource addProductSource(String aSupplierCode, String aAdvertisedCostPerUnit, Product aProduct)
  {
    return new ProductSource(aSupplierCode, aAdvertisedCostPerUnit, aProduct, this);
  }
