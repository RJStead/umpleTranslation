...
public class GridSetteableString implements IGenerator {

  protected static String nl;
  public static synchronized GridSetteableString create(String lineSeparator)
  {
    nl = lineSeparator;
    GridSetteableString result = new GridSetteableString();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = "}\" >" + NL + "\t\t\t</h:outputText>";
