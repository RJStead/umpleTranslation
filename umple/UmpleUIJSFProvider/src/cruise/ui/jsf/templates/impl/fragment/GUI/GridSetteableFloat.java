...
public class GridSetteableFloat implements IGenerator {

  protected static String nl;
  public static synchronized GridSetteableFloat create(String lineSeparator)
  {
    nl = lineSeparator;
    GridSetteableFloat result = new GridSetteableFloat();
    nl = null;
    return result;
  }
