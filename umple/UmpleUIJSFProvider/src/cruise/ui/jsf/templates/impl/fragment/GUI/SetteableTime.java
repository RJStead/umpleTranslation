...
public class SetteableTime implements IGenerator {

  protected static String nl;
  public static synchronized SetteableTime create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableTime result = new SetteableTime();
    nl = null;
    return result;
  }
