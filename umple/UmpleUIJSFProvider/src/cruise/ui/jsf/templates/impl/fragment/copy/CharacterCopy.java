...
public class CharacterCopy implements IGenerator {

  protected static String nl;
  public static synchronized CharacterCopy create(String lineSeparator)
  {
    nl = lineSeparator;
    CharacterCopy result = new CharacterCopy();
    nl = null;
    return result;
  }
