...
public class ImmutableEditDouble implements IGenerator {

  protected static String nl;
  public static synchronized ImmutableEditDouble create(String lineSeparator)
  {
    nl = lineSeparator;
    ImmutableEditDouble result = new ImmutableEditDouble();
    nl = null;
    return result;
  }
