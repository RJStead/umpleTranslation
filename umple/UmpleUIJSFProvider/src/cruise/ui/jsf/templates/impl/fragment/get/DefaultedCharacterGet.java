...
public class DefaultedCharacterGet implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedCharacterGet create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedCharacterGet result = new DefaultedCharacterGet();
    nl = null;
    return result;
  }
