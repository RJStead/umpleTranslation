...
public class SetteableDateSet implements IGenerator {

  protected static String nl;
  public static synchronized SetteableDateSet create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableDateSet result = new SetteableDateSet();
    nl = null;
    return result;
  }
