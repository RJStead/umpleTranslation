...
public class InternalTimeSet implements IGenerator {

  protected static String nl;
  public static synchronized InternalTimeSet create(String lineSeparator)
  {
    nl = lineSeparator;
    InternalTimeSet result = new InternalTimeSet();
    nl = null;
    return result;
  }
