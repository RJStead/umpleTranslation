...
public class InternalFloatCreate implements IGenerator {

  protected static String nl;
  public static synchronized InternalFloatCreate create(String lineSeparator)
  {
    nl = lineSeparator;
    InternalFloatCreate result = new InternalFloatCreate();
    nl = null;
    return result;
  }
