...
public class SetteableTimeDeclaration implements IGenerator {

  protected static String nl;
  public static synchronized SetteableTimeDeclaration create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableTimeDeclaration result = new SetteableTimeDeclaration();
    nl = null;
    return result;
  }
