...
public class GridSetteableTime implements IGenerator {

  protected static String nl;
  public static synchronized GridSetteableTime create(String lineSeparator)
  {
    nl = lineSeparator;
    GridSetteableTime result = new GridSetteableTime();
    nl = null;
    return result;
  }
