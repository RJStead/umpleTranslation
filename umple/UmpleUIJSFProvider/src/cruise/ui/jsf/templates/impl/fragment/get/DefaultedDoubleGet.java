...
public class DefaultedDoubleGet implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedDoubleGet create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedDoubleGet result = new DefaultedDoubleGet();
    nl = null;
    return result;
  }
