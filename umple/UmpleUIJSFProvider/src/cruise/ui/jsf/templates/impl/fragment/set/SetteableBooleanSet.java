...
public class SetteableBooleanSet implements IGenerator {

  protected static String nl;
  public static synchronized SetteableBooleanSet create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableBooleanSet result = new SetteableBooleanSet();
    nl = null;
    return result;
  }
