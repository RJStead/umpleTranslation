...
public class DefaultedDateDeclaration implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedDateDeclaration create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedDateDeclaration result = new DefaultedDateDeclaration();
    nl = null;
    return result;
  }
