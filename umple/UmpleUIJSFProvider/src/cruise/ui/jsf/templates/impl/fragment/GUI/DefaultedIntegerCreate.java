...
public class DefaultedIntegerCreate implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedIntegerCreate create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedIntegerCreate result = new DefaultedIntegerCreate();
    nl = null;
    return result;
  }
