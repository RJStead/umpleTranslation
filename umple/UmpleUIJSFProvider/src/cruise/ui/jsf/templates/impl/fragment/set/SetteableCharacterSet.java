...
public class SetteableCharacterSet implements IGenerator {

  protected static String nl;
  public static synchronized SetteableCharacterSet create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableCharacterSet result = new SetteableCharacterSet();
    nl = null;
    return result;
  }
