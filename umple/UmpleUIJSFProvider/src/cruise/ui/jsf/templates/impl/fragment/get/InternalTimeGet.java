...
public class InternalTimeGet implements IGenerator {

  protected static String nl;
  public static synchronized InternalTimeGet create(String lineSeparator)
  {
    nl = lineSeparator;
    InternalTimeGet result = new InternalTimeGet();
    nl = null;
    return result;
  }

  public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
  protected final String TEXT_1 = "\t\tpublic int get";
  protected final String TEXT_2 = "() {" + NL + "\t\t\treturn ";
  protected final String TEXT_3 = ";" + NL + "\t\t}" + NL + "\t\tpublic int get";
  protected final String TEXT_4 = "() {" + NL + "\t\t\treturn ";
  protected final String TEXT_5 = ";" + NL + "\t\t}" + NL + "\t\tpublic Time get";
  protected final String TEXT_6 = "() {" + NL + "\t\t\treturn ";
  protected final String TEXT_7 = ".components.bean.TimeBean.getSqlTime(";
  protected final String TEXT_8 = ", ";
  protected final String TEXT_9 = ");" + NL + "\t\t}";
  protected final String TEXT_10 = NL + NL + "\t\t" + NL + "" + NL + "\t\tpublic ";
  ...
  protected final String TEXT_20 = "();" + NL + "\t\t\tif (time!=null){" + NL + "\t\t\t\tCalendar cal=Calendar.getInstance();" + NL + "\t\t    \tcal.setTime(time);" + NL + "   \t\t\t\treturn cal.get(Calendar.HOUR_OF_DAY);" + NL + "\t\t      }" + NL + "\t\t    \treturn 0;" + NL + "\t\t}";
