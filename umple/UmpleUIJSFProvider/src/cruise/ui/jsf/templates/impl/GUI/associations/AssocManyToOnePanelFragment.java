...
public class AssocManyToOnePanelFragment
{
  protected static String nl;
  public static synchronized AssocManyToOnePanelFragment create(String lineSeparator)
  {
    nl = lineSeparator;
    AssocManyToOnePanelFragment result = new AssocManyToOnePanelFragment();
    nl = null;
    return result;
  }
