...
public class DefaultedIntegerDeclaration implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedIntegerDeclaration create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedIntegerDeclaration result = new DefaultedIntegerDeclaration();
    nl = null;
    return result;
  }
