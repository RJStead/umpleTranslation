...
public class AssocNManyToOptionalPanelFragment
{
  protected static String nl;
  public static synchronized AssocNManyToOptionalPanelFragment create(String lineSeparator)
  {
    nl = lineSeparator;
    AssocNManyToOptionalPanelFragment result = new AssocNManyToOptionalPanelFragment();
    nl = null;
    return result;
  }
