...
public class DefaultedFloatDeclaration implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedFloatDeclaration create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedFloatDeclaration result = new DefaultedFloatDeclaration();
    nl = null;
    return result;
  }
