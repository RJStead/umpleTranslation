...
public class AssocZeroOrOnePanelFragment
{
  protected static String nl;
  public static synchronized AssocZeroOrOnePanelFragment create(String lineSeparator)
  {
    nl = lineSeparator;
    AssocZeroOrOnePanelFragment result = new AssocZeroOrOnePanelFragment();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_11 = "/gridSelectOne.xhtml\">" + NL + "\t\t\t<ui:param name=\"mainPanel\" value=\"";
  ...
  protected final String TEXT_16 = "MainPanel#{uniqueId}\" immediate=\"true\" " + NL + "\t\t\t\t\t\toncomplete=\"Richfaces.hideModalPanel('";
