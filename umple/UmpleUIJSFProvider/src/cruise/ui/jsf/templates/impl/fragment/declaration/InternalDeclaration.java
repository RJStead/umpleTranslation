...
public class InternalDeclaration implements IGenerator {

  protected static String nl;
  public static synchronized InternalDeclaration create(String lineSeparator)
  {
    nl = lineSeparator;
    InternalDeclaration result = new InternalDeclaration();
    nl = null;
    return result;
  }
