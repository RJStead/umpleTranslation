...
public class DefaultedBooleanEdit implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedBooleanEdit create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedBooleanEdit result = new DefaultedBooleanEdit();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_2 = "}\" />" + NL + "<h:panelGrid columns=\"2\">" + NL + "<h:selectBooleanCheckbox id=\"";
  protected final String TEXT_3 = "#{uniqueId}\" value=\"#{#1#Bean.";
  protected final String TEXT_4 = "}\" />" + NL + "\t<a4j:commandLink " + NL + "\t\taction=\"#{#1#Bean.resetToDefaulted";
