...
public class DefaultedDoubleDeclaration implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedDoubleDeclaration create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedDoubleDeclaration result = new DefaultedDoubleDeclaration();
    nl = null;
    return result;
  }
