...
public class DefaultedIntegerGet implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedIntegerGet create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedIntegerGet result = new DefaultedIntegerGet();
    nl = null;
    return result;
  }
