...
public class SetteableStringSet implements IGenerator {

  protected static String nl;
  public static synchronized SetteableStringSet create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableStringSet result = new SetteableStringSet();
    nl = null;
    return result;
  }
