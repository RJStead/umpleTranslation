...
public class DefaultedCharacterCreate implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedCharacterCreate create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedCharacterCreate result = new DefaultedCharacterCreate();
    nl = null;
    return result;
  }
