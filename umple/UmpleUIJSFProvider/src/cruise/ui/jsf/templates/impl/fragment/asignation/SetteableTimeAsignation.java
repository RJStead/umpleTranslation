...
public class SetteableTimeAsignation implements IGenerator {

  protected static String nl;
  public static synchronized SetteableTimeAsignation create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableTimeAsignation result = new SetteableTimeAsignation();
    nl = null;
    return result;
  }
