...
public class SetteableDoubleSet implements IGenerator {

  protected static String nl;
  public static synchronized SetteableDoubleSet create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableDoubleSet result = new SetteableDoubleSet();
    nl = null;
    return result;
  }
