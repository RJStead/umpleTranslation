...
public class SetteableFloatSet implements IGenerator {

  protected static String nl;
  public static synchronized SetteableFloatSet create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableFloatSet result = new SetteableFloatSet();
    nl = null;
    return result;
  }
