...
public class DefaultedDoubleCreate implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedDoubleCreate create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedDoubleCreate result = new DefaultedDoubleCreate();
    nl = null;
    return result;
  }
