...
public class DefaultedCharacterEdit implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedCharacterEdit create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedCharacterEdit result = new DefaultedCharacterEdit();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_4 = "}\" >" + NL + "<f:converter converterId=\"javax.faces.Character\" />" + NL + "</h:inputText>" + NL + "\t<a4j:commandLink " + NL + "\t\taction=\"#{#1#Bean.resetToDefaulted";
