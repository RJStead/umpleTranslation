...
public class GridSetteableDate implements IGenerator {

  protected static String nl;
  public static synchronized GridSetteableDate create(String lineSeparator)
  {
    nl = lineSeparator;
    GridSetteableDate result = new GridSetteableDate();
    nl = null;
    return result;
  }
