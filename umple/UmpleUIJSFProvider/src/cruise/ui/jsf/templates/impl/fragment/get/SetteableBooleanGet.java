...
public class SetteableBooleanGet implements IGenerator {

  protected static String nl;
  public static synchronized SetteableBooleanGet create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableBooleanGet result = new SetteableBooleanGet();
    nl = null;
    return result;
  }
