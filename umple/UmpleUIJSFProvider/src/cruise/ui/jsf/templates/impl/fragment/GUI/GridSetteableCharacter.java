...
public class GridSetteableCharacter implements IGenerator {

  protected static String nl;
  public static synchronized GridSetteableCharacter create(String lineSeparator)
  {
    nl = lineSeparator;
    GridSetteableCharacter result = new GridSetteableCharacter();
    nl = null;
    return result;
  }
