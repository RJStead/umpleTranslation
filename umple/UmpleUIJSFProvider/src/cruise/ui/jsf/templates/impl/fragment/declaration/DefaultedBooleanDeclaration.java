...
public class DefaultedBooleanDeclaration implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedBooleanDeclaration create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedBooleanDeclaration result = new DefaultedBooleanDeclaration();
    nl = null;
    return result;
  }
