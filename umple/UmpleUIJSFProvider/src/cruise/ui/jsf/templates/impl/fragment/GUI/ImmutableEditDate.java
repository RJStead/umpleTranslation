...
public class ImmutableEditDate implements IGenerator {

  protected static String nl;
  public static synchronized ImmutableEditDate create(String lineSeparator)
  {
    nl = lineSeparator;
    ImmutableEditDate result = new ImmutableEditDate();
    nl = null;
    return result;
  }
