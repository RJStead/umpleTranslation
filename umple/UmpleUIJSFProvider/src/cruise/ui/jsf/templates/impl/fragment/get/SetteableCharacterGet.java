...
public class SetteableCharacterGet implements IGenerator {

  protected static String nl;
  public static synchronized SetteableCharacterGet create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableCharacterGet result = new SetteableCharacterGet();
    nl = null;
    return result;
  }
