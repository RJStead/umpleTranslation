...
public class SetteableStringDeclaration implements IGenerator {

  protected static String nl;
  public static synchronized SetteableStringDeclaration create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableStringDeclaration result = new SetteableStringDeclaration();
    nl = null;
    return result;
  }
