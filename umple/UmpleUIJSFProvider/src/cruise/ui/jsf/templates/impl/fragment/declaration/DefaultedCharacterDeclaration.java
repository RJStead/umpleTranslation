...
public class DefaultedCharacterDeclaration implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedCharacterDeclaration create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedCharacterDeclaration result = new DefaultedCharacterDeclaration();
    nl = null;
    return result;
  }
