...
public class DefaultedStringGet implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedStringGet create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedStringGet result = new DefaultedStringGet();
    nl = null;
    return result;
  }
