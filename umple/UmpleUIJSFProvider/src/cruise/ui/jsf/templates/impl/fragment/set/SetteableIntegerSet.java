...
public class SetteableIntegerSet implements IGenerator {

  protected static String nl;
  public static synchronized SetteableIntegerSet create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableIntegerSet result = new SetteableIntegerSet();
    nl = null;
    return result;
  }
