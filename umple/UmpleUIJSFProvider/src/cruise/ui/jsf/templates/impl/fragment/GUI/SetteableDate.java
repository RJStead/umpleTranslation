...
public class SetteableDate implements IGenerator {

  protected static String nl;
  public static synchronized SetteableDate create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableDate result = new SetteableDate();
    nl = null;
    return result;
  }
