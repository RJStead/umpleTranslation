...
public class AssocManyToOneSingletonFormFragment
{
  protected static String nl;
  public static synchronized AssocManyToOneSingletonFormFragment create(String lineSeparator)
  {
    nl = lineSeparator;
    AssocManyToOneSingletonFormFragment result = new AssocManyToOneSingletonFormFragment();
    nl = null;
    return result;
  }
