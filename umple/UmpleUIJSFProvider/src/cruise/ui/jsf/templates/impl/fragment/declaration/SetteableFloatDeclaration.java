...
public class SetteableFloatDeclaration implements IGenerator {

  protected static String nl;
  public static synchronized SetteableFloatDeclaration create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableFloatDeclaration result = new SetteableFloatDeclaration();
    nl = null;
    return result;
  }
