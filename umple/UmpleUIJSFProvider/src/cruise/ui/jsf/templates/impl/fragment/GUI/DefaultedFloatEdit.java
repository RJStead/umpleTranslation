...
public class DefaultedFloatEdit implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedFloatEdit create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedFloatEdit result = new DefaultedFloatEdit();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_4 = "}\" >" + NL + "<f:converter converterId=\"javax.faces.Float\" />" + NL + "</h:inputText>" + NL + "\t<a4j:commandLink " + NL + "\t\taction=\"#{#1#Bean.resetToDefaulted";
