...
public class DefaultedFloatGet implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedFloatGet create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedFloatGet result = new DefaultedFloatGet();
    nl = null;
    return result;
  }
