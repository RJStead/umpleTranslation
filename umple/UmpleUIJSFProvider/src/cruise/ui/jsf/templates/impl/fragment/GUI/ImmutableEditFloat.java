...
public class ImmutableEditFloat implements IGenerator {

  protected static String nl;
  public static synchronized ImmutableEditFloat create(String lineSeparator)
  {
    nl = lineSeparator;
    ImmutableEditFloat result = new ImmutableEditFloat();
    nl = null;
    return result;
  }
