...
public class SetteableIntegerGet implements IGenerator {

  protected static String nl;
  public static synchronized SetteableIntegerGet create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableIntegerGet result = new SetteableIntegerGet();
    nl = null;
    return result;
  }
