...
public class DefaultedIntegerEdit implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedIntegerEdit create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedIntegerEdit result = new DefaultedIntegerEdit();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_4 = "}\" >" + NL + "<f:converter converterId=\"javax.faces.Integer\" />" + NL + "</h:inputText>" + NL + "\t<a4j:commandLink " + NL + "\t\taction=\"#{#1#Bean.resetToDefaulted";
