...
public class GridSetteableInteger implements IGenerator {

  protected static String nl;
  public static synchronized GridSetteableInteger create(String lineSeparator)
  {
    nl = lineSeparator;
    GridSetteableInteger result = new GridSetteableInteger();
    nl = null;
    return result;
  }
