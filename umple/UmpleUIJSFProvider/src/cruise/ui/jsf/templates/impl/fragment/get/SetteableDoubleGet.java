...
public class SetteableDoubleGet implements IGenerator {

  protected static String nl;
  public static synchronized SetteableDoubleGet create(String lineSeparator)
  {
    nl = lineSeparator;
    SetteableDoubleGet result = new SetteableDoubleGet();
    nl = null;
    return result;
  }
