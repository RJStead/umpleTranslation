...
public class DefaultedStringEdit implements IGenerator {

  protected static String nl;
  public static synchronized DefaultedStringEdit create(String lineSeparator)
  {
    nl = lineSeparator;
    DefaultedStringEdit result = new DefaultedStringEdit();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_4 = "}\" >" + NL + "</h:inputText>" + NL + "\t<a4j:commandLink " + NL + "\t\taction=\"#{#1#Bean.resetToDefaulted";
