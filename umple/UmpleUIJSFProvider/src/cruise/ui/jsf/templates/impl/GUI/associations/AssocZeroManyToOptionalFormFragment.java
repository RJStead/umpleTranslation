...
public class AssocZeroManyToOptionalFormFragment
{
  protected static String nl;
  public static synchronized AssocZeroManyToOptionalFormFragment create(String lineSeparator)
  {
    nl = lineSeparator;
    AssocZeroManyToOptionalFormFragment result = new AssocZeroManyToOptionalFormFragment();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = NL + "\t\t\t\t\t<h:panelGrid columns=\"2\" \t >" + NL + "<rich:simpleTogglePanel switchType=\"client\"  label=\"\" style=\"width:350px; text-align:center;\" >\t" + NL + "\t\t\t<f:facet name=\"openMarker\">" + NL + "\t\t\t\t<h:outputText value=\"Show #{";
  protected final String TEXT_4 = "Bundle.";
  protected final String TEXT_5 = "}s +\" style=\"font-weight:bold;color:black;\"/>" + NL + "\t\t\t</f:facet>" + NL + "\t\t\t<f:facet name=\"closeMarker\">" + NL + "\t\t\t\t<h:outputText value=\"Hide #{";
  protected final String TEXT_6 = "Bundle.";
  protected final String TEXT_7 = "}s -\" style=\"font-weight:bold;color:black;\"/>" + NL + "\t\t\t</f:facet>\t\t\t\t" + NL + "\t<rich:dataTable value=\"#{";
  protected final String TEXT_8 = "List}\" var=\"reg\"" + NL + "\t\tonRowMouseOver=\"this.style.backgroundColor='#F1F1F1'\" style=\"align:center;\"" + NL + "\t\tonRowMouseOut=\"this.style.backgroundColor='#{a4jSkin.tableBackgroundColor}'\" rows=\"10\" rowKeyVar=\"row\"\t>" + NL + "\t\t<f:facet name=\"header\">" + NL + "\t\t\t<h:outputText value=\"#{";
  protected final String TEXT_9 = "Bundle.";
  protected final String TEXT_10 = "}\" />" + NL + "\t\t</f:facet>" + NL + "" + NL + "\t\t";
  ...
  protected final String TEXT_17 = "PanelRichPanel#{uniqueId}\"" + NL + "\t\t\timmediate=\"true\" " + NL + "\t\t\taction=\"#{";
  protected final String TEXT_18 = "Bean.to";
  protected final String TEXT_19 = "}\"" + NL + "\t\t\toncomplete=\"Richfaces.showModalPanel('";
