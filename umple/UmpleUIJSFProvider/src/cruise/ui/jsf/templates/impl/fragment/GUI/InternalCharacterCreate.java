...
public class InternalCharacterCreate implements IGenerator {

  protected static String nl;
  public static synchronized InternalCharacterCreate create(String lineSeparator)
  {
    nl = lineSeparator;
    InternalCharacterCreate result = new InternalCharacterCreate();
    nl = null;
    return result;
  }
