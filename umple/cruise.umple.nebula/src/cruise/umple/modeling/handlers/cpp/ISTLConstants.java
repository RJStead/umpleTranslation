...
public interface ISTLConstants {
	...
	public static final String STD_LIBRARY = "std";  //$NON-NLS-1$
	...
	public static final String TIME_INCLUDE= "time"; //$NON-NLS-1$
	public static final String C_TYPE= "ctype"; //$NON-NLS-1$
	public static final String STDIO= "stdio"; //$NON-NLS-1$
