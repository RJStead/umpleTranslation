...
class Election
{
  ...
  public function __construct($aIdElection, $aName, $aDescription, $aDate)
  {
  ...
  {
    $wasSet = false;
    if (!$this->canSetIdElection) { return false; }
    $this->idElection = $aIdElection;
    $wasSet = true;
    return $wasSet;
  }
  ...
  public function addPollVia($aIdPoll, $aNumber, $aName, $aDescription)
  {
  ...
  {
    $wasAdded = false;
    if ($this->indexOfPoll($aPoll) !== -1) { return false; }
